...
function ChangeMyMood() {
  ...
  return (
    <div className="col-span-full mb-4 lg:col-start-8 lg:col-end-13">
      <div className="bg-black/10 flex flex-col justify-start p-4 relative rounded-md">
        <button
        ...
        <code className="text-emerald-400 text-xs md:text-sm mb-2">
          <pre>
        ...
        <div className="flex gap-2 text-lg">
          {buttons.map((button) => (
            <button
              key={button.id}
              className="hover:brightness-110 rounded-sm bg-white/10 w-8 h-8 border border-white/10 inline-flex justify-center items-center"
